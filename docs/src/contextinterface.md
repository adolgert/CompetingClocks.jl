...
CompetingClocks.next(::SamplingContext{K,T}) where {K,T}
...
CompetingClocks.clone(::SamplingContext{K,T,Sampler,RNG,Like,CRN,Dbg}, rng::RNG) where {K,T,Sampler,RNG,Like,CRN,Dbg}
